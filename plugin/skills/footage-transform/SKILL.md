...
2. **Load the craft guide:**
   [`references/guide-footage-transformation.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-footage-transformation.md)
...
- Seedance 2.x: [`references/models/model-video-seedance-pro.md`](${CLAUDE_PLUGIN_ROOT}/context/model-video-seedance-pro.md)
...
Check [`references/model-currency-2026-06.md`](${CLAUDE_PLUGIN_ROOT}/context/model-currency-2026-06.md)
