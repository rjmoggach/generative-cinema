...
[`references/models/`](${CLAUDE_PLUGIN_ROOT}/context/) for syntax/parameters, and check
...
Full detail: [`references/model-layer-priority.md`](${CLAUDE_PLUGIN_ROOT}/context/model-layer-priority.md).
Six-layer reference: [`references/guide-prompting-framework.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-prompting-framework.md).
Shot terminology (BCU/CU/MS/LS, angles, movement): [`references/reference-film-grammar.md`](${CLAUDE_PLUGIN_ROOT}/context/reference-film-grammar.md).

**Craft decision rules** (the *why* behind each choice — read the relevant one before generating):
- Shot size, push-in vs cut, coverage intent: [`references/guide-shot-selection.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-shot-selection.md)
- Focal length, DOF, lensing by emotion/genre: [`references/guide-lens-language.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-lens-language.md)
- Spatial continuity (180/30/eyeline/screen direction): [`references/guide-continuity-rules.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-continuity-rules.md)
- Building a whole scene (coverage modes, A/I/L staging, intensity arc): [`references/guide-sequence-construction.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-sequence-construction.md)
- Visual intensity (contrast/affinity, the 7 components): [`references/guide-visual-structure.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-visual-structure.md)
- Color schemes + associative color: [`references/guide-color-story.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-color-story.md)
- Authorial intent (motivated camera, POV, subtext, rule-breaking): [`references/guide-creative-approaches.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-creative-approaches.md)
- Making it survive real model limits (continuity, drift, iteration): [`references/guide-ai-generation-strategy.md`](${CLAUDE_PLUGIN_ROOT}/context/guide-ai-generation-strategy.md)
